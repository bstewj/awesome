...
globalkeys = my_table.join(
    ...
    {description = "Dmenu", group = "Search"}),



    -- Rofi Drun
    awful.key({ modkey }, "space", function () awful.util.spawn( "rofi -show drun -show-icons  True -lines 10 -line-margin 10 -padding 200 -bw 0" ) end,
        {description = "Rofi Drun", group = "Rofi"}),
    --Rofi Fullscreen
    awful.key({ modkey }, "F11", function () awful.util.spawn( "rofi -show run -fullscreen" ) end,
        {description = "Rofi Fullscreen" , group = "Rofi" }),
    --Rofi Run
    ...
    awful.key({ modkey }, "r", function () awful.util.spawn( "rofi-theme-selector" ) end,
        {description = "Rofi Theme Selector", group = "Rofi"}),
    --Browser
    --Brave-Browser
    awful.key({ modkey }, "w", function () awful.util.spawn( "brave-browser" ) end,
        {description = "Brave-Browser", group = "Browser"}),
    --Firefox
    ...
    --File Managers
    --Ranger
    awful.key({ modkey1, altkey   }, "t", function() awful.util.spawn( "kitty -e ranger") end,
    ...
    --Kitty
    awful.key({ modkey,           }, "Return", function () awful.spawn("kitty -e fish") end,
        {description = "Kitty", group = "Terminal"}),
    --Terminator
    awful.key({ modkey, altkey   }, "Return", function() awful.util.spawn("terminator -e fish") end,
        {description = "Terminator", group = "Terminal"}),
    --Screen Lock
    --Betterlockscreen
    awful.key({ modkey, "Shift"  }, "x", function () awful.util.spawn( "/home/dmne/.local/bin/betterlockscreen -l dimblur" ) end,
        {description = "Betterlockscreen" , group = "Screen Lock" }),
    --Cointop
    awful.key({altkey }, "c", function () awful.util.spawn( " kitty -e /home/dmne/go/bin/cointop" ) end,
        {description = "Cointop" , group = "Ticker"}),
    --Text Editor
    --Emacs
    awful.key({ modkey,           }, "a", function () awful.spawn("emacs") end,
        {description = "Atom", group = "Text Editor"}),
    --Mousepad

    --Music
    --MOCP
    awful.key({ modkey, altkey   }, "m", function() awful.util.spawn("kitty -e mocp") end,
        {description = "MOC", group = "Media"}),
    --Deadbeef
    awful.key({ modkey, altkey   }, "d", function() awful.util.spawn("deadbeef") end,
        {description = "Deadbeef", group = "Media"}),
    --Picard
    awful.key({ modkey, altkey   }, "p", function() awful.util.spawn("picard") end,
        {description = "Musicbrainz", group = "Media"}),
    --Social
    --Telegram
    awful.key({ modkey, altkey   }, "t", function() awful.util.spawn("telegram-desktop") end,
        {description = "Telegram", group = "Social"}),
    --Signal
    awful.key({ modkey, altkey   }, "s", function() awful.util.spawn("signal-desktop") end,
        {description = "Signal", group = "Social"}),
    --Synaptic
    awful.key({ modkey1, altkey   }, "s", function() awful.util.spawn("synaptic-pkexec") end,
        {description = "Synaptic Package Manager", group = "Package Manager"}),
    --Xfce4-appfinder
    awful.key({ modkey }, "e", function () awful.util.spawn( "xfce4-appfinder" ) end,
        {description = "xfce4-appfinder", group = "Search"}),
    --Galculator
    awful.key({ modkey }, "g", function () awful.util.spawn( "galculator" ) end,
        {description = "Galculator", group = "Calcultor"}),
    --Email
    awful.key({ altkey }, "e", function () awful.util.spawn( "tutanota-desktop" ) end,
        {description = "Tutanota Email", group = "Email"}),
    --Screenshot
    --Flameshot
    awful.key({ altkey }, "f", function () awful.util.spawn( "flameshot" ) end,
        {description = "Flameshot", group = "Screenshot"}),
    --Nitrogen
    awful.key({ modkey1, altkey   }, "i", function() awful.util.spawn("nitrogen") end,
        {description = "Nitrogen", group = "Wallpaper"}),
    ...
    --WM-Logout
    awful.key({ modkey }, "x",  function () awful.util.spawn( "wm-logout" ) end,
      {description = "WM-Logout", group = "Logout"}),
...
clientkeys = my_table.join(
    awful.key({ altkey, "Shift"   }, "",      lain.util.magnify_client,
